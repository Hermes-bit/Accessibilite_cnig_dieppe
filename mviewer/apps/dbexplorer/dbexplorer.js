...
const DbExplorer = (function () {
    ...
    const TABLES_URL = "/api/v1/db/tables";
    const QUERY_URL  = "/api/v1/db/query";
    const EXPORT_URL = "/api/v1/db/export";
    const IMPORT_URL = "/api/v1/db/import";
    const DROP_TABLE_URL = "/api/v1/db/drop_table";
